    ...
    return (
        <View style={ styles.calculatorContainer }>
            ...
            <View style={ styles.buttonContainer }>
                ...
                <CalculatorButton blockButton={ blockButton } title="÷" isActive={ state.isActive } currentButtonActive={ state.typeOfOperation }  background={ colors.orange } /* textColor={ buttonTextColor } */ dispatch={ () => dispatch({type:'operation', payload:'/'}) }/>
            </View>
            <View style={ styles.buttonContainer }>
                ...
                <CalculatorButton blockButton={ blockButton } title="x" isActive={ state.isActive } currentButtonActive={ state.typeOfOperation }  background={ colors.orange } /* textColor={ buttonTextColor } */ dispatch={ () => dispatch({type:'operation', payload:'x'}) }/>
            </View>
            <View style={ styles.buttonContainer }>
